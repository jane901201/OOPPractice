...
namespace Unreal.AssetResources
{
    public abstract class IResources
    {
        ...
        public abstract TextAsset LoadXML(string SaveData);
        ...
        public abstract void SaveSaveDataFileDataBase(SaveDataFileDataBase saveData);

        public abstract SaveDataFileDataBase LoadSaveDataFileDataBaseXML();
